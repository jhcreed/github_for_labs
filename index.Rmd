...
Both .accent-orange[GitHub] and .accent-orange[GitLab] use .accent-orange[git] for code versioning within their service. Additional differences exist between the two concerning terminology, popularity, continuous integration and 3rd party software. 
